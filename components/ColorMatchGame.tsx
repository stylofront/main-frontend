...
export default function ColorMatchGame() {
    ...
    return (
        <div className="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 py-12 px-4 sm:px-6">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="text-sm md:text-base text-white/60 font-body mb-4">
                    ...
                    <div className="flex gap-3 sm:gap-4 justify-center items-center flex-wrap">
                        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-lg px-4 py-2">
                            <p className="text-white/60 text-xs font-body mb-0.5">Moves</p>
                            <p className="text-xl font-bold font-heading text-white">{moves}</p>
                        </div>
                        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-lg px-4 py-2">
                            <p className="text-white/60 text-xs font-body mb-0.5">Matches</p>
                            <p className="text-xl font-bold font-heading text-white">{matches}/6</p>
                        </div>
                        {bestScore && (
                            <div className="bg-gradient-to-r from-blue-600/20 to-blue-700/20 backdrop-blur-md border border-blue-500/30 rounded-lg px-4 py-2">
                                <p className="text-blue-300 text-xs font-body mb-0.5 flex items-center gap-1 justify-center">
                                    <FaTrophy className="w-3 h-3" /> Best
                                </p>
                                <p className="text-xl font-bold font-heading text-blue-300">{bestScore}</p>
                            </div>
                        )}
                    </div>
                </div>
                ...
                {/* Game Board */}
                <div className="grid grid-cols-3 sm:grid-cols-4 gap-2 sm:gap-3 mb-6 max-w-md mx-auto">
                    {cards.map((card) => (
                        <button
                            key={card.id}
                ...
                <div className="text-center">
                    <button
                        ...
                        className="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold font-body rounded-lg transition-all transform hover:scale-105 hover:shadow-xl hover:shadow-blue-500/30 text-sm inline-flex items-center gap-2"
                    >
