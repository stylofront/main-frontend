    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        ...
        <div className="mb-6 animate-fade-in">
          <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 bg-clip-text text-transparent mb-3 tracking-tight">
            StyloFront
          </h1>
        </div>
        ...
        <div className="inline-block mb-6 animate-fade-in animation-delay-500">
          <span className="px-4 py-1.5 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-white/90 text-xs font-medium tracking-wider">
            COMING SOON
          </span>
        </div>

        {/* Main heading */}
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 animate-fade-in animation-delay-1000 leading-tight">
        ...
        {/* Subheading */}
        <p className="text-base md:text-lg text-white/60 mb-10 max-w-xl mx-auto animate-fade-in animation-delay-1500 leading-relaxed">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 justify-center items-center max-w-md mx-auto animate-fade-in animation-delay-2000">
          <input
            ...
            required
            className="w-full sm:flex-1 px-5 py-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm"
          />
          <button
            type="submit"
            disabled={status === 'sending'}
            className="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:from-blue-800 disabled:to-blue-900 text-white font-semibold rounded-lg transition-all transform hover:scale-105 hover:shadow-xl hover:shadow-blue-500/30 text-sm"
          >
        ...
        {/* Social links */}
        <div className="mt-12 animate-fade-in animation-delay-2500">
          <p className="text-white/40 text-xs mb-3">
            Follow our journey
          </p>
          <div className="flex gap-5 justify-center">
            <a href="#" className="text-white/50 hover:text-white transition-colors transform hover:scale-110">
